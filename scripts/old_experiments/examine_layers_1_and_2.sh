: '
Script to run experiments examining layers 1 and 2.

'
export CUDA_VISIBLE_DEVICES=0

experiment_name="examine_layers_1_and_2"
...
local_k=1
LOCAL_IN_SCOPE=("layers.1\,layers.2") # "mlp\,attn\,norm\,embed"
LOCAL_OUT_SCOPE=("none" ) # "layers.1\,layers.2"
local_shuffle="False"
