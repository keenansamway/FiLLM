...
local_k=1
LOCAL_IN_SCOPE=("layers.3") # "layers.0\,layers.12\,layers.26"
...
do
    ...
    do
        ...
        torchrun src/evaluate_util.py --config-name=eval_everything.yaml \
            model_family=${model_family} \
        ...
        python3 src/aggregate_eval_stat.py \
            ...
            save_file="results/tofu/${experiment_name}/${model_family}_${ft_lr}_${ft_checkpoint}_unlearn_${unlearn_info}.csv"
    done
done