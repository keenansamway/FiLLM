...
experiment_name="layer_comparison_k1"
...
retain_checkpoint="checkpoint-618" # (checkpoint-618, checkpoint-593, checkpoint-562)
...
local_k=1
LOCAL_IN_SCOPE=("mlp\,attn\,norm\,embed" "mlp\,attn\,norm" "mlp" "attn" "attn" "norm")
LOCAL_OUT_SCOPE=("none" "none" "bias" "bias" "none" "bias")
local_shuffle="False"
