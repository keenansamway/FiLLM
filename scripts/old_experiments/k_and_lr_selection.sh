...
Methods tested
    - LOCAL_K=(1 0.5 0.1 0.05)
    - FORGET_LR=(1e-05 5e-05 1e-04 5e-04)
'
export CUDA_VISIBLE_DEVICES=0

experiment_name="k_and_lr_selection"
...
for idx1 in "${!LOCAL_K[@]}"
do
    local_k=${LOCAL_K[$idx1]}
    for idx2 in "${!FORGET_LR[@]}"
    do
        forget_lr=${FORGET_LR[$idx2]}
