...
FORGET_CHECKPOINT=({2..20..2}) # ("checkpoint-125" "checkpoint-62" "checkpoint-12") for ebs of 16
...
local_out_scope="layers.1\,layers.2"
local_shuffle="False"
compression_power=16

experiment_name="performance_over_time_${forget_lr}_all\(-layers.1\,layers.2\)_${forget_loss}"
