: '
Script to run experiments looking into so-influence top vs bottom vs random.

'
export CUDA_VISIBLE_DEVICES=0

experiment_name="proportional_layer_comparison_k0.1"
...
local_k=0.1
LOCAL_IN_SCOPE=("mlp\,attn" "mlp")
local_out_scope="bias"
LOCAL_SHUFFLE=("False" "False" "True" "True")
