: '
Script to run experiments comparing average versus per datapoint influence calculations.
Methods tested
    - LOCAL_METHOD=("none" "so-influence" "so-influence-pd")

'
export CUDA_VISIBLE_DEVICES=0

experiment_name="avg-influence_vs_pd-influence"
...
FORGET_LR=("1e-05") # ("1e-05" "5e-05" "5e-05" "5e-05")

LOCAL_METHOD=("so-influence-pd") # ("none" "none" "so-influence" "so-influence-pd")
local_num_retain=800
LOCAL_K=(0.1) # (1 1 0.1 0.1)
local_in_scope="mlp"
