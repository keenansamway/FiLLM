...
# TOFU args #
    ...
    ft_epochs=10
    ft_lr="2.5e-05"
    ft_checkpoint="checkpoint-500" # tofu: floor(4000 * epochs / batch_size * gradient_accumulation_steps)
    retain_checkpoint="checkpoint-487" # tofu: floor({3960, 3800, 3600} * epochs / batch_size * gradient_accumulation_steps)
...
# TOFU args #
    ...
    ft_epochs=10
    ft_lr="2.5e-05"
    ft_checkpoint="checkpoint-250" # tofu: floor(4000 * epochs / batch_size * gradient_accumulation_steps)
    retain_checkpoint="checkpoint-237" # tofu: floor({3960, 3800, 3600} * epochs / batch_size * gradient_accumulation_steps)
...
# KnowUnDo args #
    ...
    FORGET_CHECKPOINT=({29..290..29}) # knowundo: floor(477 * epochs / batch_size * gradient_accumulation_steps)
else
...
# Run experiments #
experiment_name="PFpL_${forget_lr}_${forget_loss}"
