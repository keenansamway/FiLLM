...
def get_datapoint_hash(data):
    """
    Takes as input a datapoint 'label' tensor and returns a hash as a unique identifier.
    """
...
def get_model_identifiers_from_yaml(model_family):
    ...
    '''
    model_configs  = {}
    with open("src/config/model_config.yaml", "r") as f:
